...
const IconUpload = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2L12 10M12 10L15 7M12 10L9 7" stroke="var(--tgui--button_color)" stroke-width="1.5" stroke-linecap="round"
            ...
            <path
                ...
                stroke="var(--tgui--button_color)" stroke-width="1.5" stroke-linecap="round"/>
            <path
